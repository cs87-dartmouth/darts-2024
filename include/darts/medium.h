...
{
public:
    /// Default constructor which accepts a #json object of named parameters; finds the medium's `"phase function"`
     ...
     */
    virtual bool sample_free_flight(const Ray3f &ray, int channel, Sampler &sampler, HitRecord &hit, Color3f &f,
                                    Color3f &p) const = 0;
