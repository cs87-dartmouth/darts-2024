...
public:
     ...
     */
    virtual Color3f emitted(const Ray3f &ray, const HitRecord &hit) const
    {
    ...
    /**
       ...
       \param  [in] ray     The incoming ray (points at surface)
       ...
       \return bool         True if the surface scatters light
    */
    virtual bool sample(const Ray3f &ray, const HitRecord &hit, ScatterRecord &srec, const Vec2f &rv, float rv1) const
    {
        return false;
    }
    ...
    /**
       ...
       \param  [in] ray         The incoming ray (points at surface)
       \param  [in] scattered   The outgoing ray direction (points out of surface)
       \param  [in] hit         The shading hit point
       \return Color3f          The evaluated color
    */
    virtual Color3f eval(const Ray3f &ray, const Vec3f &scattered, const HitRecord &hit) const
    {
        return Color3f(0.0f);
    }
    ...
    */
    virtual float pdf(const Ray3f &ray, const Vec3f &scattered, const HitRecord &hit) const
    {
        return 0.0f;
    }
};
